 ...
 *
 *   --connect                -> "auto": ports remembered by `jev-browser-use chrome`, then 9222-9229
...
/**
 * Endpoint URL safe for logs, `jev-browser-use status` and registry keys: remote CDP
...
export function chromeLaunchHint(): string {
  return (
    "Start Chrome with remote debugging, for example `jev-browser-use chrome` (recommended), or\n" +
    "  macOS:  open -a 'Google Chrome' --args --remote-debugging-port=9222 --user-data-dir=$HOME/.jev-browser-use/v1/browsers/manual\n" +
    "  Linux:  google-chrome --remote-debugging-port=9222 --user-data-dir=$HOME/.jev-browser-use/v1/browsers/manual\n" +
