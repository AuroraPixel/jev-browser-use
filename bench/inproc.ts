...
const home = fs.mkdtempSync(path.join(os.tmpdir(), "jev-browser-use-inproc-"));
...
try {
  ...
  console.log(`jev-browser-use ${VERSION} in-process runScript (no socket, no client), ${RUNS} runs`);
