...
export function smallHtml(): string {
  ...
  return `<!doctype html>
<html lang="en">
<head><meta charset="utf-8"><title>jev-browser-use bench: small</title>
...
<body>
<header><h1>jev-browser-use</h1><nav aria-label="Main"><ul>${navItems}</ul></nav></header>
<main>
  ...
  <section id="about"><h2>About</h2>
    <p>jev-browser-use is a browser automation CLI for coding agents. Scripts are plain Puppeteer; a warm daemon keeps Chrome
...
<footer><p>&copy; 2026 jev-browser-use &middot; <a href="/terms">Terms</a> &middot; <a href="/privacy">Privacy</a></p>
