/**
 * End-to-end: named pages, anonymous pages, listPages/closePage, `jev-browser-use pages`.
 */
...
beforeAll(async () => {
  cli = makeCliEnv("jev-browser-use-e2e-pages-");
...
describe("named pages", () => {
  ...
  test("pages file under JEV_BROWSER_USE_HOME/pages/*.json contains the name -> targetId", async () => {
...
describe("jev-browser-use pages", () => {
