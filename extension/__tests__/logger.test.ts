...
describe("createLogger", () => {
  ...
  describe("log", () => {
    it("should log to console and send message", () => {
      ...
      expect(console.log).toHaveBeenCalledWith("[jev-browser-use]", "test message", 123);
  ...
  describe("debug", () => {
    it("should debug to console and send message", () => {
      ...
      expect(console.debug).toHaveBeenCalledWith("[jev-browser-use]", "debug info");
      expect(mockSendMessage).toHaveBeenCalledWith({
        method: "log",
        params: {
          level: "debug",
  ...
  describe("error", () => {
    it("should error to console and send message", () => {
      ...
      expect(console.error).toHaveBeenCalledWith("[jev-browser-use]", "error occurred");
      expect(mockSendMessage).toHaveBeenCalledWith({
        method: "log",
        params: {
          level: "error",
